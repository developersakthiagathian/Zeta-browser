...
htmlhelp_basename = 'ZetaBrowserdoc'
...
latex_documents = [
    (master_doc, 'ZetaBrowser.tex', 'Zeta Browser Documentation',
     'Zeta Software', 'manual'),
]
...
man_pages = [
    (master_doc, 'Zetabrowser', 'Zeta Browser Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'ZetaBrowser', 'Zeta Browser Documentation',
     author, 'ZetaBrowser', 'One line description of project.',
     'Miscellaneous'),
]
